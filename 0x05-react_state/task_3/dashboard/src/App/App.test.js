...
describe('App component', () => {
  ...
  it('verifies that markNotificationAsRead removes the notification from the state', () => {
    const mockNotifications = [
      { id: 1, type: 'default', value: 'New course available' },
      { id: 2, type: 'urgent', value: 'New resume available' },
      { id: 3, type: 'urgent', __html: 'Latest notification' },
    ];
    component.setState({ listNotifications: mockNotifications });

    component.instance().markNotificationAsRead(2);

    const updatedNotifications = component.state().listNotifications;
